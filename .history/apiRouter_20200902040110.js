...
const mutuelleCtrl = require('./routes/mutuelle.controller');
const prestationCtrl = require('./routes/prestation.controller');
const mesureCtrl = require('./routes/mesure.controller');
const antecedentCtrl = require('./routes/antecedent.controller');
...
exports.router = (() => {
    ...
    apiRouter.route('/patient/get-by-user/:id').get(patientCtrl.getAllByUser);
    apiRouter.route('/patient/get-by-id/:id').get(patientCtrl.getById);
    apiRouter.route('/patient/:id').put(patientCtrl.update);
    apiRouter.route('/patient/update-profile').put(patientCtrl.updateProfile);
    apiRouter.route('/patient/update-password').put(patientCtrl.updatePassword);
    apiRouter.route('/patient/delete/:id').put(patientCtrl.remove);

    // Mesures Routes
    apiRouter.route('/patient/mesure').post(mesureCtrl.addNew);
    apiRouter.route('/patient/mesure/:id').get(mesureCtrl.getAllByPatient);
    apiRouter.route('/patient/mesure/:id').put(mesureCtrl.update);
    apiRouter.route('/patient/mesure/:id').delete(mesureCtrl.delete);

    // Antecedents Routes
    apiRouter.route('/patient/antecedent').post(antecedentCtrl.addNew);
    apiRouter.route('/patient/antecedent/:id').get(antecedentCtrl.getAllByPatient);
    apiRouter.route('/patient/antecedent/:id').put(antecedentCtrl.update);
    apiRouter.route('/patient/antecedent/:id').delete(antecedentCtrl.delete);

    // Mutuelles Routes
    apiRouter.route('/mutuelle').post(mutuelleCtrl.addNew);
    apiRouter.route('/mutuelle').get(mutuelleCtrl.getAll);
    apiRouter.route('/mutuelle/:id').put(mutuelleCtrl.update);
    apiRouter.route('/mutuelle/delete/:id').put(mutuelleCtrl.delete);

    // Prestations Routes
    apiRouter.route('/prestation').post(prestationCtrl.addNew);
    apiRouter.route('/prestation').get(prestationCtrl.getAll);
    apiRouter.route('/prestation/:id').get(prestationCtrl.getAllByEtablissement);
    apiRouter.route('/prestation/:id').put(prestationCtrl.update);
    apiRouter.route('/prestation/delete/:id').post(prestationCtrl.delete);
