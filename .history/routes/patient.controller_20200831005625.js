...
module.exports = {
    ...
    getAll: (req, res) => {
        ...
        models.Patient.findAll({
            attributes: ['id', 'civilite', 'nom', 'prenom', 'sexe', 'dateNaissance', 'lieuNaissance', 'securiteSocial', 'situationFamiliale', 'profession', 'groupeSanguin', 'rfid', 'adresse', 'username', 'telMobile', 'telDomicile', 'telPro', 'email', 'createdBy', 'expireAt', 'status', 'createdAt', 'updatedAt'],
            include: [
