...
module.exports = {
    ...
    addNew: (req, res) => {
        ...
        let secutiteSocial = req.body.secutiteSocial;
    ...
    getAll: (req, res) => {
        ...
        models.User.findAll({
            attributes: ['id', 'matricule', 'civilite', 'nom', 'prenom', 'sexe', 'phoneNumber', 'email', 'secutiteSocial', 'adresse', 'username', 'lastConnexion', 'expireAt', 'status', 'createdAt', 'updatedAt'],
            include: [
